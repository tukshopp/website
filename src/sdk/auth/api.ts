 ...
 * 
 * @export
 * @interface CreateRiderAccountDTO
 */
export interface CreateRiderAccountDTO {
    /**
     * 
     * @type {string}
     * @memberof CreateRiderAccountDTO
     */
    'email': string;
    /**
     * 
 ...
 * 
 * @export
 * @interface CreateVendorAccountDTO
 */
export interface CreateVendorAccountDTO {
    /**
     * 
     * @type {string}
     * @memberof CreateVendorAccountDTO
     */
    'email': string;
    /**
     * 
    ...
    'referralCode': string;
    /**
     * Name of the vendor, used across the Tukshopp platform.
     * @type {string}
     * @memberof CreateVendorAccountDTO
     */
    'vendorName'?: string;
 ...
 * 
 * @export
 * @interface SigninAsResponsePayload
 */
export interface SigninAsResponsePayload {
    /**
     * 
     * @type {string}
     * @memberof SigninAsResponsePayload
     */
    'token': string;
}
/**
...
export const AuthApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        authControllerGoogleSignin: async (googleSigninDTO: GoogleSigninDTO, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'googleSigninDTO' is not null or undefined
            assertParamExists('authControllerGoogleSignin', 'googleSigninDTO', googleSigninDTO)
        ...
        /**
         * 
         * @param {CreateRiderAccountDTO} createRiderAccountDTO 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        authControllerSignupRider: async (createRiderAccountDTO: CreateRiderAccountDTO, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'createRiderAccountDTO' is not null or undefined
            assertParamExists('authControllerSignupRider', 'createRiderAccountDTO', createRiderAccountDTO)
            const localVarPath = `/v1/auth/signup-rider`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(createRiderAccountDTO, localVarRequestOptions, configuration)
        ...
        /**
         * 
         * @param {CreateVendorAccountDTO} createVendorAccountDTO 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        authControllerSignupVendor: async (createVendorAccountDTO: CreateVendorAccountDTO, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'createVendorAccountDTO' is not null or undefined
            assertParamExists('authControllerSignupVendor', 'createVendorAccountDTO', createVendorAccountDTO)
            const localVarPath = `/v1/auth/signup-vendor`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(createVendorAccountDTO, localVarRequestOptions, configuration)
...
export const AuthApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async authControllerGoogleSignin(googleSigninDTO: GoogleSigninDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SigninResponsePayload>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.authControllerGoogleSignin(googleSigninDTO, options);
         ...
         * @throws {RequiredError}
         */
        async authControllerSigninAs(signinAsDTO: SigninAsDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SigninAsResponsePayload>> {
         ...
         * @throws {RequiredError}
         */
        async authControllerSignupRider(createRiderAccountDTO: CreateRiderAccountDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SignupResponsePayload>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.authControllerSignupRider(createRiderAccountDTO, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AuthApi.authControllerSignupRider']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async authControllerSignupVendor(createVendorAccountDTO: CreateVendorAccountDTO, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SignupResponsePayload>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.authControllerSignupVendor(createVendorAccountDTO, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AuthApi.authControllerSignupVendor']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const AuthApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        authControllerGoogleSignin(googleSigninDTO: GoogleSigninDTO, options?: RawAxiosRequestConfig): AxiosPromise<SigninResponsePayload> {
            return localVarFp.authControllerGoogleSignin(googleSigninDTO, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {SigninDTO} signinDTO 
         ...
         * @throws {RequiredError}
         */
        authControllerSigninAs(signinAsDTO: SigninAsDTO, options?: RawAxiosRequestConfig): AxiosPromise<SigninAsResponsePayload> {
         ...
         * @throws {RequiredError}
         */
        authControllerSigninWIthOtp(signinOTPDTO: SigninOTPDTO, options?: RawAxiosRequestConfig): AxiosPromise<SigninWithOTPResponsePayload> {
         ...
         * @throws {RequiredError}
         */
        authControllerSignupRider(createRiderAccountDTO: CreateRiderAccountDTO, options?: RawAxiosRequestConfig): AxiosPromise<SignupResponsePayload> {
            return localVarFp.authControllerSignupRider(createRiderAccountDTO, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {CreateVendorAccountDTO} createVendorAccountDTO 
         ...
         * @throws {RequiredError}
         */
        authControllerSignupVendor(createVendorAccountDTO: CreateVendorAccountDTO, options?: RawAxiosRequestConfig): AxiosPromise<SignupResponsePayload> {
            return localVarFp.authControllerSignupVendor(createVendorAccountDTO, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class AuthApi extends BaseAPI {
     ...
     * @memberof AuthApi
     */
    public authControllerGoogleSignin(googleSigninDTO: GoogleSigninDTO, options?: RawAxiosRequestConfig) {
        return AuthApiFp(this.configuration).authControllerGoogleSignin(googleSigninDTO, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AuthApi
     */
    public authControllerSignupRider(createRiderAccountDTO: CreateRiderAccountDTO, options?: RawAxiosRequestConfig) {
        return AuthApiFp(this.configuration).authControllerSignupRider(createRiderAccountDTO, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof AuthApi
     */
    public authControllerSignupVendor(createVendorAccountDTO: CreateVendorAccountDTO, options?: RawAxiosRequestConfig) {
        return AuthApiFp(this.configuration).authControllerSignupVendor(createVendorAccountDTO, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const HelpersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        accountHelperControllerCheckEmailAvailability: async (email: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'email' is not null or undefined
            assertParamExists('accountHelperControllerCheckEmailAvailability', 'email', email)
            const localVarPath = `/v1/auth/account-helper/availability/email`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        accountHelperControllerCheckPhoneAvailability: async (phone: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'phone' is not null or undefined
            assertParamExists('accountHelperControllerCheckPhoneAvailability', 'phone', phone)
            const localVarPath = `/v1/auth/account-helper/availability/phone`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
            if (configuration) {
...
export const HelpersApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async accountHelperControllerCheckEmailAvailability(email: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AvailabilityCheckDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.accountHelperControllerCheckEmailAvailability(email, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['HelpersApi.accountHelperControllerCheckEmailAvailability']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async accountHelperControllerCheckPhoneAvailability(phone: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AvailabilityCheckDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.accountHelperControllerCheckPhoneAvailability(phone, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['HelpersApi.accountHelperControllerCheckPhoneAvailability']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const HelpersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        accountHelperControllerCheckEmailAvailability(email: string, options?: RawAxiosRequestConfig): AxiosPromise<AvailabilityCheckDTO> {
            return localVarFp.accountHelperControllerCheckEmailAvailability(email, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @param {string} phone 
         ...
         * @throws {RequiredError}
         */
        accountHelperControllerCheckPhoneAvailability(phone: string, options?: RawAxiosRequestConfig): AxiosPromise<AvailabilityCheckDTO> {
            return localVarFp.accountHelperControllerCheckPhoneAvailability(phone, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class HelpersApi extends BaseAPI {
     ...
     * @memberof HelpersApi
     */
    public accountHelperControllerCheckEmailAvailability(email: string, options?: RawAxiosRequestConfig) {
        return HelpersApiFp(this.configuration).accountHelperControllerCheckEmailAvailability(email, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof HelpersApi
     */
    public accountHelperControllerCheckPhoneAvailability(phone: string, options?: RawAxiosRequestConfig) {
        return HelpersApiFp(this.configuration).accountHelperControllerCheckPhoneAvailability(phone, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const PasswordApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        authControllerForgotPasswordOTPReset(forgotPasswordOTPDTO: ForgotPasswordOTPDTO, options?: RawAxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        authControllerResetPasswordOTPAuthorization(resetPasswordOTPAuthorizationDTO: ResetPasswordOTPAuthorizationDTO, options?: RawAxiosRequestConfig): AxiosPromise<ResetPasswordOTPAuthorizationResPayload> {
...
export const VerificationsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        authControllerCompleteEmailVerification(verificationEmailDTO: VerificationEmailDTO, options?: RawAxiosRequestConfig): AxiosPromise<void> {
         ...
         * @throws {RequiredError}
         */
        authControllerSendEmailVerification(sendEmailVerificationCredDTO: SendEmailVerificationCredDTO, options?: RawAxiosRequestConfig): AxiosPromise<void> {
