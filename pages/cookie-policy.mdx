...
<div>
This Cookie Policy explains how <strong>Tukshopp</strong> ("**Company**," "**we**," "**us**," and "**our**") uses cookies and similar technologies to recognize you when you visit our website at [https://tukshopp.ng](https://tukshopp.ng) ("**Website**"). It explains what these technologies are and why we use them, as well as your rights to control our use of them.
...
<div>
  Cookies set by the website owner (in this case, <strong>__________</strong> ) are called
...
<strong>care@tukshopp.com</strong>
</PageLayout>
