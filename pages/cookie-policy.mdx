...
<div>
This Cookie Policy explains how <strong>__________</strong> ("**Company**," "**we**," "**us**," and "**our**") uses cookies and similar technologies to recognize you when you visit our website at [https://tukshopp.ng](https://tukshopp.ng) ("**Website**"). It explains what these technologies are and why we use them, as well as your rights to control our use of them.
